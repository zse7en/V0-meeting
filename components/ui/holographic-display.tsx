        ...
        >
          ...
          <div className="relative w-full h-full">
            ...
            <motion.div
              ...
              className="w-full h-full bg-black/10 backdrop-blur-xl border border-cyan-400/30 rounded-lg p-4 overflow-hidden"
            >
              {/* Title Bar */}
              ...
              {/* Content */}
              <div className="h-full overflow-hidden">{getContent()}</div>
            </motion.div>
