...
export default function FloatingPanel({ phase, isActive, isThinking, onClick }: FloatingPanelProps) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.5, delay: phase.id * 0.2 }}
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: isActive ? 4 : 0.3, repeat: isActive ? Number.POSITIVE_INFINITY : 0 }}
        className="relative w-20 h-20 rounded-xl bg-black/20 backdrop-blur-xl border border-white/20 flex flex-col items-center justify-center p-2"
        style={{
      ...
      >
        ...
        {/* Name */}
        <div className="text-xs text-white/80 mt-1 text-center font-medium">{phase.name}</div>
